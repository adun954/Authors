...
const Author = (props) => {
    ...
    const onSubmitHandler = e => {
        ...
        .catch(err=>{
            console.log(err)
            // to find errorResponse you must first -> Console ->
            // message properties -> find the objects the access to the 
            // validations
            const errorResponse = err.response.data.errors.name; // Get the errors from err.response.data
